...
const MORE_TOPICS = [
  {
    ...
    body: [
      ...
      "I love making plans and following them through — it's easier to make decisions when you have a good plan. I excel at making plans for my daily life, and I try to do the same in my work when I plan something, splitting tasks so they're easier to focus on.\nI have a GTD system I've been using for more than 7 years which includes writing everything down and then sorting it out every morning. Additionally I have certain strategies for planning big tasks more effectively to avoid confusion and procrastination. They say by failing to prepare, you are preparing to fail — good plans is 80% of work.",
      "I try my best to focus on outcomes instead of effort required whether that's going for a run or making a new project. By focusing on what's to come rather than on how much work is required — I usually avoid lots of problems with laziness and procrastination.",
      ...
      "From the start of my career, during COVID, I had to work remotely most of the time — it was really hard at first. I've read lots of productivity/psychology books trying to fix it, and it worked — now I can work alone in a room all day and still get through the work. I've managed to set this work-life balance perfectly, and it got me through the years of work without a single burnout.",
      "I had an unfortunate time during university when COVID and then the military draft hit my country. I worried a lot and had an abundance of stress because of everything that was happening in the world. It was really difficult to go through the start of my 20s at that time. Once again, I found my salvation in books — I read philosophy, which helped me get through it and improve myself. Now I'm trying not to think about all this too much and focus on the small, good things in life — I've learned that nothing good comes from pointlessly worrying about things.",
    ],
  },
  {
    id: 'ai',
    ...
    body: [
      'I have lots of opinions about AI. I use agents myself to keep up with the trend, as I always have, but I cannot say I enjoy it.',
      "Writing code has always been something delicate to me. After I read a book called \"Clean Code\" during my university years, I've been trying to write code the way you'd write a book — agents don't really follow that rule. Even if you feed lots of context to an AI agent, you can't expect it to write exactly like you want.\nThat is my huge problem with AI, in addition to the obvious one — killing the enjoyment of writing code by your own hand. I've read so many stories of people getting tired of being just a \"verification layer\" between an agent and the codebase.",
      'In my personal projects, I like to keep AI usage to a minimum. But in production, it depends a lot on the context.',
      "AI can build so much in so little time, but it can't do the one thing senior developers still do — take responsibility. Senior devs care a lot about understanding the system and making it simple, because that allows fixing it when things go wrong. It allows extending it when the system needs to grow. It allows providing reliable service to customers.",
      'So why use AI in the first place? Because the business needs to grow fast, push more things to market, and test new hypotheses. Everyone can push code using AI, but if you have a bunch of agents, junior devs, non-developers, and investors adding code to the system, you get a system that overcompensates for speed by giving up the stability we care about so much.',
      ...
      "That's why I think AI usage depends a lot on context. What kind of system do we want? Do we want to push as many things as possible to market and see how users react? Or do we want a stable and reliable system?\nIt's a delicate matter that requires a lot of attention in this twisted tech world we currently live in.",
    ],
  },
]
